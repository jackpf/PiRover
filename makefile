...
controller:
	g++ -std=$(std) $(warnings) $(debug) controller.cpp lib/lib.cpp lib/rover.cpp lib/server.cpp lib/gpio.cpp -lpthread -o bin/controller

lights:
	g++ -std=$(std) $(warnings) $(debug) lights.cpp lib/lib.cpp lib/gpio.cpp -lpthread -o bin/lights
